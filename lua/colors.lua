...
local theme = {
    Neovim = [[habamax]], --habamax dracula eva01-LCL eva01-LCL badwolf sitruuna lunaperch spacecampe industry ron carbonfox duskfox nightfox tokyodark bamboo onedark
